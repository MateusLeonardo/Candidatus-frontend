...
interface ConfirmDialogProps {
    deleteMutation: UseMutationResult<any, AxiosError<IResponseError, any>, number, unknown>;
    id: number;
    title: string;
}
export function ConfirmDialog({ deleteMutation, id, title }: ConfirmDialogProps) {
    return (
        <>
            <AlertDialog>

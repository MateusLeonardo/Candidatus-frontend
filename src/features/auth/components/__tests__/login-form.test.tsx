...
import * as mutationLoginModule from "../../hooks/use-mutation-login";
...
vi.mock("../../hooks/use-mutation-login", () => ({
  useMutationLogin: vi.fn(),
}));
...
describe("LoginForm", () => {
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    vi.mocked(mutationLoginModule.useMutationLogin).mockReturnValue(
      mockMutation as any,
    );
  });
